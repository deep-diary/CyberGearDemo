...
void TC_PositionRegulation(PosCtrl_Handle_t *pHandle)
{
  ...
  if (pHandle->PositionControlRegulation == ENABLE)
  {
    ...
    speedRef = PID_Controller(pHandle->PIDPosRegulator, wError);
...
/**
  * @brief  Returns the current estimated mechanical anglular position, expressed in radiant.
  * @param  pHandle: handler of the current instance of the Position Control component.
  * @retval current estimated mechanical angular position
  */
float TC_GetCtrlPositionAngle(PosCtrl_Handle_t *pHandle)
{
...
/**
  * @brief  Sets the current estimated mechanical angular position.
  * @param  pHandle: handler of the current instance of the Position Control component.
  * @param  fCurrentPosition current mechanical angular position (in radian).
  */
void TC_SetCtrlPositionAngle(PosCtrl_Handle_t *pHandle, float fCurrentPosition)
{
  pHandle->Theta = fCurrentPosition;
}
