 ...
 #define MT6701_CS_Enable HAL_GPIO_WritePin(SPI_CS_GPIO_Port, SPI_CS_Pin, GPIO_PIN_RESET)
 #define MT6701_CS_Disable HAL_GPIO_WritePin(SPI_CS_GPIO_Port, SPI_CS_Pin, GPIO_PIN_SET)

 #define ENCODER_SPI_MAX 16384 
 #define POLES 15

 extern SPI_HandleTypeDef hspi1;
// // const uint8_t pole_pairs = 15; // 极对数
 ...
 int16_t MT6701_GetRawAngle(void)
{
    ...
    int16_t SPI_EIAngle = (-(int16_t)((65536*rawData*POLES)/ENCODER_SPI_MAX)%65536);
    return SPI_EIAngle;
