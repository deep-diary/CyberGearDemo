...
/* returns the current angle of position control algorithm of Motor 1. */
float_t MC_GetCtrlPositionAngle1(void);

/* sets the current angle of position control algorithm of Motor 1. */
void MC_SetCtrlPositionAngle1(float_t fCurrentPosition);
