...
#define M1_SS_MEAS_ERRORS_BEFORE_FAULTS     20 /*!< Number of speed measurement errors before main sensor goes in fault */
...
#define PID_SPEED_KP_DEFAULT               7000/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT               80/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KD_DEFAULT                0/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/

/* Speed control loop */
#define SPEED_LOOP_FREQUENCY_HZ             (uint16_t)4000 /*!<Execution rate of speed regulation loop (Hz) */
...
#define PID_POSITION_KP_GAIN                50
 ...
 *** Control Parameters ***
 **************************/
#define POSITION_LOOP_FREQUENCY_HZ             (uint16_t)1000 /*!<Execution rate of speed regulation loop (Hz) */
/* ##@@_USER_CODE_START_##@@ */
/* ##@@_USER_CODE_END_##@@ */
